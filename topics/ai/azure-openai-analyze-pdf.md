...
#### 安裝環境
0. 我們會使用到poetry建立虛擬環境

`pip install poetry `

2.  poetry建立虛擬環境地點

`poetry new chatbotdemo`
...
`poetry add langchain langchain-openai langchain-community langchain-cli qdrant-client pypdf`

5. 記得要讓你的 Python 虛擬環境是 3.11 以上
