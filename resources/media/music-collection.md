...
- 歌曲應優先依據其本身的情感與曲風，分配至對應的「情感分類」中。
- 在**同一情感分類**下，若同一歌手有 **2首或以上** 的歌曲，則為其建立專門的歌手子分類：`### **歌手名 (分類縮寫)**`
- 在**同一情感分類**下，只有 1 首歌曲的歌手，統一放在該分類最後的 `### **其他歌手 (分類縮寫)**` 中
- **注意**：同一位歌手的歌曲若風格不同，應分別放在不同的情感分類中（例如周杰倫會在多個分類中出現），不需要跨分類強制集中
...
[**窩窩 & 顧墨跡 - 離巢**](https://www.youtube.com/watch?v=YVa33cbMtH8)
